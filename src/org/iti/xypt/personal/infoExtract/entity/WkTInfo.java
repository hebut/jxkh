...
public class WkTInfo implements java.io.Serializable {
	...
	private String kiExtraname;
	// Constructors

	public String getKiExtraname() {
		return kiExtraname;
	}

	public void setKiExtraname(String kiExtraname) {
		this.kiExtraname = kiExtraname;
	}
	...
	public WkTInfo(Long kiId,Long keId, String kiPtime,String kiUrl,String kiRegion,String kiTitle,String kiAuthname, String kiTitle2, String kiSource,
			...
			String kiShow,String kiExtraname) {
		this.keId=keId;
		this.kiId = kiId;
