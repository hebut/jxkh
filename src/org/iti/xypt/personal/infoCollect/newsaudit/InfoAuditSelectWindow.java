...
public class InfoAuditSelectWindow extends Window implements AfterCompose {
...
//加载数据
	...
	class InnerListener implements EventListener
	{
		public void onEvent(Event event) throws Exception 
		{
			...
			NewsAuditSelDetailWindow w=(NewsAuditSelDetailWindow)Executions.createComponents("/admin/personal/infoExtract/newsaudit/newseldetail.zul",null, null);	
			w.doHighlighted();
		}
		}
	//关闭窗口
