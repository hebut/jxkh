...
public class CprojectWindow extends Window implements AfterCompose {
	...
	public void initShow() {
		...
		List<Jxkh_Project> cProjectList1 = jxkhProjectService.findAllCPByDept(user.getDept().getKdNumber());
	...
	public void onClick$query3() {
		...
		List<Jxkh_Project> projectList1 = jxkhProjectService.findCPByCondition(nameSearch3, auditStateSearch3, user.getDept().getKdNumber());
