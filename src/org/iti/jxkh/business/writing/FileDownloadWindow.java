...
public class FileDownloadWindow extends BaseWindow {
	...
	public void onClick$download() {
		...
		try {
			...
			System.out.println("宋雨的路径是："+filePath);
			System.out.println("打包下载时宋雨的file长度："+fileList.size());
...
//						.getRealPath("/jxkh/writing/1/" + project.getId() + "/"
//								+ file.getName()));
//			}
//			if (file.getPath().contains("\\jxkh\\writing\\2\\")) {
//				DownLoadFile.onDownfile(UploadUtil
//						.getRealPath("/jxkh/writing/2/" + project.getId() + "/"
//								+ file.getName()));
//			}
//			if (file.getPath().contains("\\jxkh\\writing\\3\\")) {
//				DownLoadFile.onDownfile(UploadUtil
//						.getRealPath("/jxkh/writing/3/" + project.getId() + "/"
//								+ file.getName()));
//			}
//			if (file.getPath().contains("\\jxkh\\writing\\4\\")) {
//				DownLoadFile.onDownfile(UploadUtil
//						.getRealPath("/jxkh/writing/4/" + project.getId() + "/"
//								+ file.getName()));
//			}
//			if (file.getPath().contains("\\jxkh\\writing\\5\\")) {
//				DownLoadFile.onDownfile(UploadUtil
//						.getRealPath("/jxkh/writing/5/" + project.getId() + "/"
//								+ file.getName()));
//			}
		}
	}
