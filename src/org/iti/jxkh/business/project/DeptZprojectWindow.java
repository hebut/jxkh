...
public class DeptZprojectWindow extends Window implements AfterCompose {
	...
	public class ZProjectRenderer implements ListitemRenderer {
		...
		public void render(Listitem item, Object data) throws Exception {
			...
			Listcell c7 = new Listcell(project.getScore() == null ? "0" : project.getScore().toString());
			String strC8;
	...
	public void onClick$query1() {
		...
		List<Jxkh_Project> projectList = jxkhProjectService.findZPByCondition2(nameSearch, auditStateSearch, indicatorId1, yearSearch1, user.getDept().getKdNumber(), zxPaging.getActivePage(), zxPaging.getPageSize());
		zxListbox.setModel(new ListModelList(projectList));
		cx1 = true;
	}
