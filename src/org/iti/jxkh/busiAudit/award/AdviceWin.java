...
public class AdviceWin extends Window implements AfterCompose {
	...
	public void initWindow() {
		...
		// 控制显示多少行，和每行的内容
		meetDeptList = jxkhAwardService.findAwardDepByAwardId(meeting);
		for (int i = 1; i <= meetDeptList.size(); i++) {
			Jxkh_AwardDept dept = (Jxkh_AwardDept) meetDeptList.get(i - 1);
			switch (i) {
			case 1:
				r1.setVisible(true);
