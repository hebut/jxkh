...
public class RecordCodeWin extends Window implements AfterCompose {
	...
	public void onClick$save() {
		...
		if (award.getState() == Jxkh_Writing.BUSINESS_PASS) {
			// 附件1
			String filePath = "";
			try {
			...
			award.setState(Jxkh_Writing.SAVE_RECORD);
		}
	...
	public Jxkh_Writing getAward() {
		return award;
	}

	public void setAward(Jxkh_Writing award) {
		this.award = award;
	}
