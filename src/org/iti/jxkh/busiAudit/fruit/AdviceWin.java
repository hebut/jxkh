...
public class AdviceWin extends Window implements AfterCompose {
	 ...
	 * @author C
	 */
	private static final long serialVersionUID = -2484500925480767316L;
	...
	public void initWindow() {
		...
		// 控制显示多少行，和每行的内容
		meetDeptList = jxkhFruitService.findFruitDepByFruitId(meeting);
		for (int i = 1; i <= meetDeptList.size(); i++) {
			Jxkh_FruitDept dept = (Jxkh_FruitDept) meetDeptList.get(i - 1);
			switch (i) {
			case 1:
				r1.setVisible(true);
