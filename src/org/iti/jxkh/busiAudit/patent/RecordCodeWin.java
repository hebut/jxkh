...
public class RecordCodeWin extends Window implements AfterCompose {
	...
	public void onClick$save() {
		...
		if (award.getState() == Jxkh_Patent.BUSINESS_PASS) {
			...
			award.setState(Jxkh_Patent.SAVE_RECORD);
		}
		try {
	...
	public Jxkh_Patent getAward() {
		return award;
	}

	public void setAward(Jxkh_Patent award) {
		this.award = award;
	}
