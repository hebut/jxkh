...
public class EditFundWindow  extends Window implements AfterCompose {
	...
	public void onClick$submit() throws InterruptedException{
		...
		try{
			...
			e.printStackTrace();
			try {
				Messagebox.show("经费信息保存失败，请重试！", "提示", Messagebox.OK, Messagebox.INFORMATION);
	...
	public class TypeRenderer implements ListitemRenderer {
		...
		public void render(Listitem item, Object data) throws Exception {
			...
			String strC3 = null;
			switch (fund.getType()) {
			case Jxkh_ProjectFund.IN:strC3 = "经费收入";break;
			case Jxkh_ProjectFund.OUT:strC3 = "院外拨款支出";break;
