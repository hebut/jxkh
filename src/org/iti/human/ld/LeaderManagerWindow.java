...
/**
 * @author DaLei
 * @version $Id: LeaderManagerWindow.java,v 1.1 2011/08/31 07:03:01 ljb Exp $
 */
public class LeaderManagerWindow extends HumanBaseWindow {
	Panel userPanel;
	West westPanel;
	Tree westTree;
	Button addUser;
	...
	public void initShow() {
		...
		leaderlist.setItemRenderer(new ListitemRenderer() {
			public void render(Listitem item, Object data) throws Exception {
				...
				// Listcell c6=new Listcell(tea.getUser().getXxDept());
