...
public class OrganizeManagerWindow extends BaseWindow {
	...
	Button addDept, sortDept, deleteDept;
	Label pdeptLabel;
	...
	public void onClick$addDept() {
		final OrganizeNewWindow w = (OrganizeNewWindow) Executions.createComponents("/admin/human/Organize/deptNew.zul", null, null);
		w.doHighlighted();
