 ...
 * @date 2010-3-18
 */
public class TeacherEditWindow extends Window implements AfterCompose {
	// 用户所在根本部门
	WkTDept rootDept;
	Teacher teacher;
	WkTRole defaultRole;
	...
	public void initWindow() {
		...
		uPass.setValue(teacher.getUser().getKuPasswd());
		uRpass.setValue(teacher.getUser().getKuPasswd());
