...
public class DudaoSelTeaWindow  extends Window implements AfterCompose {
	...
	public Long getSelectKdid() {
		return selectKdid;
	}

	public void setSelectKdid(Long selectKdid) {
		this.selectKdid = selectKdid;
	}
	...
	public void onClick$submit() {
		List slist = this.getSelectUser();
		for (int i = 0; i < slist.size(); i++) {
			Teacher t = (Teacher) slist.get(i);
			XyUserroleId xyrId = new XyUserroleId(noRoleId, t.getKuId());
			XyUserrole xyr = new XyUserrole(xyrId, selectKdid);
