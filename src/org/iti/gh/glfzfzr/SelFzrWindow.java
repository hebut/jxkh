...
public class SelFzrWindow extends Window implements AfterCompose{
	Panel userPanel;
	West westPanel;
	Tree westTree;
	Listbox leaderlist;
	...
	public void onClick$search() {
		...
		List tlist = teacherService.findNoFxfzrTeacher(dlist, role.getKrId(),nameSearch.getValue(), tnoSearch.getValue());
