package org.iti.projectmanage.science.reference;
...
public class ReferenceListWindow extends Window implements AfterCompose {
	...
	public void onClick$search()
	{
		...
		List<Long> countList = referenceService.findCountByTKAPSF(sourceType, sourceType, content, startTime, endTime,clcString,issueString,GhXm.KYXM);
		int reTotalSize = 0;
		...
		List<GH_ARCHIVE> arList = referenceService.findByTKAPSFAndPage(sourceType, searchFiled,
				content, startTime, endTime,clcString,issueString,GhXm.KYXM, 0, referencePaging.getPageSize());
	...
	public class PagingListener implements EventListener {
		...
		public void onEvent(Event event) throws Exception 
		{
			List<GH_ARCHIVE> arList = referenceService.findByTKAPSFAndPage(sourceType, searchFiled, content, 
					startTime, endTime,clcString,issueString,GhXm.KYXM,referencePaging.getActivePage(), referencePaging.getPageSize());
