...
/**
 * <li>项目名称: Kygl科研管理
 * <li>功能描述: 实现横向项目结项报告的订制功能
 * <li>版权: Copyright (c) 信息技术研究所
 */
public class HResultReportWindow extends Window implements AfterCompose{
	
	private static final long serialVersionUID = -1397177361099476338L;
	private Logger  log  = Logger.getLogger(HResultReportWindow.class);
