...
public class StageReportWindow extends BaseWindow {
			...
			public void render(Listitem arg0, Object arg1) throws Exception {				
				...
				c2.addEventListener(Events.ON_CLICK, new EventListener() {
					...
					public void onEvent(Event arg0) throws Exception {					
						StageReportViewWindow srv = (StageReportViewWindow)Executions.createComponents("/admin/personal/data/teacherinfo/jxqk/member/reportDetail.zul", null, null);
	...
	public void onClick$addReport() throws SuspendNotAllowedException, InterruptedException {
		StageReportAddWindow sraw = (StageReportAddWindow)Executions.createComponents("/admin/personal/data/teacherinfo/jxqk/member/newReport.zul", null, null);
		sraw.setXm(xm);
		sraw.initWindow();
	...
	public void onClick$search() {
		...
		ReportSearchWindow rsw = (ReportSearchWindow)Executions.createComponents("/admin/personal/data/teacherinfo/jxqk/member/searchReport.zul", null, null);
		rsw.setXm(xm);
