...
public class StageEditWindow extends Window implements AfterCompose {
						 ...
						 Listcell c5=new Listcell();
							Hbox hbox1 = new Hbox();
							 ...
							 task.addEventListener(Events.ON_CLICK, new EventListener() {
									public void onEvent(Event arg0) throws Exception {
										DistributeTaskWindow w=(DistributeTaskWindow)Executions.createComponents("/admin/personal/data/teacherinfo/jxqk/member/distributeTask.zul", null, null);
										w.initWindow(member);
	...
	public void viewWx(GhJsxm member)
	{
		...
		JYArticalWindow w=(JYArticalWindow)Executions.createComponents("/admin/personal/data/teacherinfo/jxqk/member/jyArticallist.zul", null, null);
		w.setXm(xmqk);
		w.setMember(member);
		w.initWindow();
		w.addEventListener(Events.ON_CHANGE, new EventListener() {
	...
	{
		StaffAddWindow add=(StaffAddWindow)Executions.createComponents("/admin/personal/data/teacherinfo/jxqk/member/addStaff.zul", null, null);
		add.initWindow(xmqk);
	...
	public void stagereport(GhJsxm member)
	{
		...
		StageReportWindow w = (StageReportWindow)Executions.createComponents("/admin/personal/data/teacherinfo/jxqk/member/stageReport.zul", null, null);
		w.setXm(xmqk);
		w.setMember(member);
		w.initWindow();
		//w.initShow();
	...
	//成员排序
	 ...
	 {
		 MemberSortWindow w=(MemberSortWindow)Executions.createComponents("/admin/personal/data/teacherinfo/jxqk/member/sort.zul", null, null);
		w.initWindow(xmqk);
