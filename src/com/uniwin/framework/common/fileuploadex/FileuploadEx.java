 ...
 * @see Filedownload
 */
public class FileuploadEx extends HtmlBasedComponent implements org.zkoss.zul.api.Fileupload { //not XulElement since not applicable
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final Log log=LogFactory.getLog(FileuploadEx.class);

	private static String _templ = "/fileupload/fileuploaddlg.zul";
	...
	protected class ExtraCtrl extends HtmlBasedComponent.ExtraCtrl implements Updatable {
		...
		public void setResult(Object result) {
			Events.postEvent(
				new UploadEvent(Events.ON_UPLOAD, FileuploadEx.this,
	 ...
	 */
	public static ImageUploadPackage get() throws InterruptedException {
		//return get(null, null, false);
		return get(null, null, 1, false);
	}
	/** Opens a modal dialog with the default message and title,
	 * and let user upload a file.
	 *
	...
	throws InterruptedException {
		final ImageUploadPackage result = get(message, title, 1, alwaysNative);
		return result != null ? result.getMedia0(): null;
	}
	 ...
	 * or null if uploaded.
	 */
	public static ImageUploadPackage get(int max) throws InterruptedException {
	 ...
	 * @see org.zkoss.zk.ui.util.Configuration#getUploadCharsetFinder
	 */
	public static ImageUploadPackage get(int max, boolean alwaysNative)
	throws InterruptedException {
	 ...
	 * or null if uploaded.
	 */
	public static ImageUploadPackage get(String message, String title, int max)
	throws InterruptedException {
	 ...
	 */
	public static
	ImageUploadPackage get(String message, String title, int max, boolean alwaysNative)
	throws InterruptedException {
	...
	public static
	ImageUploadPackage get(String message, String title, int max, int maxsize, boolean alwaysNative)
	throws InterruptedException {
		final Map<String, Comparable> params = new HashMap<String, Comparable>(8);
		...
		Component fUD=exec.createComponents(_templ, null, params);
		FileuploadDlgEx dlg=null;
		try{
			dlg=(FileuploadDlgEx)fUD;
		}catch(Exception e){
			log.error(e);
		}
		try {
