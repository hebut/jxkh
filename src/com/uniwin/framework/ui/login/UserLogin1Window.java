...
public class UserLogin1Window extends Window implements AfterCompose {
	...
	public void afterCompose() {
		...
		//System.out.print(EncodeUtil.encodeByDES("100801006000256"));
	...
	public void onClick$loginButton() throws Exception {
		...
		password = j_password.getValue().toString().trim();
