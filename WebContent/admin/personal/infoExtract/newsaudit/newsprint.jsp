<%@ page language="java" import="java.util.*"
	import="org.iti.xypt.personal.infoCollect.entity.*" pageEncoding="UTF-8"%>
<%
...
<!--资讯内容-->
		...
		<br/>
		<div height="5px"></div>
		<div align="center" style="font-size: 13px; color: red; font-family: 宋体"> 来源:<%=info.getKiSource()%>              作者:<%=info.getKuName() %>           发布时间:<%=dis.getKbDtime().substring(0,10) %>   </div>
		<br/>
		<div> <%=cnt %></div>
		</body>
		</html>