...
<body>
	...
	<p align="center" >
		...
		<br/>
		<strong style="font-size: 25px">科研影视详细信息</strong>
	</p>
	<div align="center">
		<table width="700" border="1" align="center" cellspacing="0">
			<tr height="43">
				<td width="150"><strong>影视名称</strong></td>
				<td width="550" colspan="3"><s:property
						value="#request.video.name" /></td>
			</tr>

			<tr height="43">
				<td width="150"><strong>项目成员及排序</strong></td>
				<td width="550" align="left" colspan="3"><s:property
						value="#request.videomember" /></td>
			</tr>

			<tr height="43">
				<td width="150"><strong>完成部门及排序</strong></td>
				<td width="550" align="left" colspan="3"><s:property
						value="#request.videodept" /></td>
			</tr>

			<tr height="43">
				<td width="150"><strong>合作单位</strong> <s:property
						value="#request.video.coCompany" /></td>
				<td width="200"></td>
				<td width="150"><strong>批示领导</strong></td>
				<td width="200"><s:property
						value="#request.video.leader.kbName" /></td>
			</tr>

			<tr height="43">
				<td width="150"><strong>影视种类</strong></td>
				<td width="200"><s:property value="#request.video.type" /></td>
				<td width="150"><strong>拍摄时间</strong></td>
				<td width="200"><s:property value="#request.video.shootTime" />
				</td>
			</tr>

			<tr height="43">
				<td width="150"><strong>播出媒体级别</strong></td>
				<td width="200"><s:property value="#request.video.rank.kbName" />
				</td>
				<td width="150"><strong>播出时间</strong></td>
				<td width="200"><s:property value="#request.video.playTime" />
				</td>
			</tr>

			<tr height="43">
				<td width="150"><strong>播出时长</strong></td>
				<td width="200"><s:property value="#request.video.longTime" />
				</td>
				<td width=150><strong>播出媒体</strong></td>
				<td width="200"><s:property value="#request.video.media" /></td>
			</tr>

			<tr height="43">
				<td width="150"><strong>信息填写人</strong></td>
				<td width="200"><s:property value="#request.video.submitName" />
				</td>
				<td width="150"><strong>档案号</strong></td>
				<td width="200"><s:property value="#request.video.recordCode" />
				</td>
			</tr>
			<tr height="120">
			...
			<tr height="120">
				...
				<td colspan="3" align="left">
					<%
						Jxkh_Video aw = (Jxkh_Video) request.getAttribute("video");
					%> <%
 	String a2;
