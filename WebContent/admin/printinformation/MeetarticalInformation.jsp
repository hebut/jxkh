...
<body>
	...
	<div align="center">
		<table width="700" border="1" align="center" cellspacing="0">
			<tr height="40">
				<td width="150"><strong>会议论文名称</strong></td>
				<td width="550" colspan="3"><s:property
						value="#request.meetArtical.lwName" /></td>
			</tr>
			<tr height="40">
			...
			<tr height="40">
				...
				<td width="200"><s:property value="#request.meetArtical.lwRank" /></td>
			</tr>

			<tr height="40">
				<td width="150"><strong>会议级别</strong></td>
				<td width="200"><s:property
						value="#request.meetArtical.lwGrade.kbName" /></td>
				<td width="150"><strong>收录类别</strong></td>
				<td width="200"><s:property
						value="#request.meetArtical.lwType.kbName" /></td>
			</tr>

			<tr height="40">
				<td width="150"><strong>会议论文集名称</strong></td>
				<td width="200"><s:property
						value="#request.meetArtical.bookName" /></td>
				<td width="150"><strong>会议论文集期次</strong></td>
				<td width="200"><s:property value="#request.meetArtical.lwQC" /></td>
			</tr>
			<tr height="40">
				<td width="150"><strong>发表时间</strong></td>
				<td width="200"><s:property value="#request.meetArtical.lwTime" /></td>
				<td width="150"><strong>信息填写人</strong></td>
				<td width="200"><s:property
						value="#request.meetArtical.lwWriter" /></td>
			</tr>
			<tr height="120">
			...
			<tr height="120">
				...
				<td colspan="3" align="left"><s:property
						value="#request.meetArtical.depReason" /></td>
			</tr>
			<tr height="120">
				<td width="150"><strong>业务办审核意见</strong></td>
				<td colspan="3" align="left"><s:property
						value="#request.meetArtical.ywReason" /></td>
			</tr>
		</table>
	</div>
</body>
