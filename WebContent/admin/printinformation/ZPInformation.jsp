...
<body>
	...
	<p align="center">
		...
		<br /> 
		<strong style="font-size: 25px">纵向项目详细信息</strong>
	</p>
	<%-- <p align="center" style="font-size: 25px">
		<strong>纵向项目详细信息</strong>
	</p> --%>
	<div align="center">
		<table width="700" border="1" align="center" cellspacing="0">
			<tr height="40">
				<td width="150"><strong>项目名称</strong></td>
				<td width="190"><s:property value="#request.zp.name" /></td>
				<td width="150"><strong>项目编号</strong></td>
				<td width="190"><s:property value="#request.zp.projecCode" />
				</td>
			</tr>

			<tr height="40">
				<td width="150"><strong>项目组成员及排序</strong></td>
			...
			<tr height="40">
				...
				<td width="190"><s:property value="#request.zpcoo" /></td>
				<td width="150"><strong>项目级别</strong></td>
				<td width="190"><s:property value="#request.zp.rank.kbName" />
				</td>
			</tr>

			<tr height="40">
				<td width="150"><strong>国家、省<br />人文社科课题
				</strong></td>
				<td width="190"><s:property value="#request.zphum" /></td>
				<td width="150"><strong>国家、省<br />软科学课题
				</strong></td>
				<td width="190"><s:property value="#request.zpsoft" /></td>
			</tr>

			<tr height="40">
				<td width="150"><strong>经费总额(万元)</strong></td>
				<td width="190"><s:property value="#request.zp.sumFund" /></td>
				<td width="150"><strong>&nbsp;&nbsp;今年到款经费<br />总额(万元)
				</strong></td>
				<td width="190"><s:property value="#request.zpfund" /></td>
			</tr>

			<tr height="40">
				<td width="150"><strong>项目负责人</strong></td>
				<td width="190"><s:property value="#request.zp.header" /></td>
				<td width="150"><strong>合同始期 </strong></td>
				<td width="190"><s:property value="#request.zp.beginDate" /></td>
			</tr>

			<tr height="40">
				<td width="150"><strong>合同终期</strong></td>
				<td width="190"><s:property value="#request.zp.endDate" /></td>
				<td width="150"><strong>项目进展 </strong></td>
				<td width="190"><s:property value="#request.zp.progress" /></td>
			</tr>

			<tr height="40">
				<td width="150"><strong>立项部门</strong></td>
				<td width="190"><s:property value="#request.zp.standDept" /></td>
				<td width="150"><strong>信息填写人</strong></td>
				<td width="190"><s:property value="#request.zpw" /></td>
			</tr>
			<tr height="120">
