...
<body>
	...
	<p align="center" >
		...
		<br/>
		<strong style="font-size: 25px">著作详细信息</strong>
	</p>
	<div align="center">
		<table width="700" border="1" align="center" cellspacing="0">
			<tr height="40">
				<td width="150"><strong>著作名称</strong></td>
				<td width="550" colspan="3"><s:property
						value="#request.writing.name" /></td>
			</tr>
			...
			<tr height="40">
				...
				<td width="150"><strong>著作类型</strong></td>
				<td width="200"><s:property
						value="#request.writing.sort.kbName" /></td>
			</tr>

			<tr height="40">
				<td width="150"><strong>是否正式出版</strong></td>
				<td width="200"><s:property value="#request.writingyn" /></td>
				<td width="150"><strong>出版社名称</strong></td>
				<td width="200"><s:property
						value="#request.writing.publishName" /></td>
			</tr>

			<tr height="40">
				<td width="150"><strong>出版时间</strong></td>
				<td width="200"><s:property
						value="#request.writing.publishDate" /></td>
				<td width="150"><strong>信息填写人</strong></td>
				<td width="200"><s:property value="#request.writingw" /></td>
			</tr>
			<tr height="120">
			...
			<tr height="120">
				...
				<td colspan="3" align="left">
					<%
						Jxkh_Writing aw1 = (Jxkh_Writing) request.getAttribute("writing");
					%> <%
 	String a1 = " ";
 ...
 %> <%=a1%></td>
			...
			<tr height="120">
				...
				<td colspan="3" align="left">
					<%
						Jxkh_Writing aw = (Jxkh_Writing) request.getAttribute("writing");
					%> <%
 	String a = " ";
